  ...
  useEffect(() => {
    const fetchForecast = async () => {
      ...
      try {
        ...
        const { normalizeForecastData, logDataSource, validateDataConsistency } = await import("@/lib/data-normalizer")
        ...
        const { normalizeForecastData } = await import("@/lib/data-normalizer")
        const mockData = [
