...
export async function GET() {
  try {
    ...
    const statusResponse = await fetch('http://127.0.0.1:8000/sheets/status');
    ...
    try {
      ...
      const inventoryResponse = await fetch('http://127.0.0.1:8000/sheets/data/Sheet1');
    ...
    try {
      ...
      const historyResponse = await fetch('http://127.0.0.1:8000/sheets/data/Sheet2');
